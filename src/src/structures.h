...
class BaseTask {
public:
	BaseTask(pointset p, double t, double var, int landmarks, double alpha, int canPolicy) : p(p), t(t), var(var), landmarks(landmarks), logGraph(false), alpha(alpha), candidatePolicy(canPolicy) {}
